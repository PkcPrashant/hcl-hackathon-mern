...
ALTER TABLE "PORTFOLIO_DETAIL" ADD FOREIGN KEY ("ID_USER_LOGIN_DETAIL") REFERENCES "USER_LOGIN_DETAIL" ("ID");

ALTER TABLE "ASSET_DETAIL" ADD FOREIGN KEY ("ID_USER_LOGIN_DETAIL") REFERENCES "USER_LOGIN_DETAIL" ("ID");
